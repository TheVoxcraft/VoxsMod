...
namespace VoxMod.Content.Items
{
    /// <summary>
    ...
    /// </summary>
    public class AdvancedDPSMeterAccessory : ModItem
    {
        ...
        {
            player.GetModPlayer<AdvancedDPSMeterInfoDisplayPlayer>().showAdvDPSMeter = true;
        }
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.DPSMeter, 1)
